...
def main() -> None:
    ...
    parser.add_argument(
        "--raw_angles_folder",
        default="/pdo/users/djtufto/altazzes_new/altazzes/",
        type=str,
        help="Folder containing O*_altaz.out files",
    )
    parser.add_argument(
        "--angle_folder", type=str, help="Output folder for processed angle data"
    )
    parser.add_argument(
        "--angle_file",
    ...
    parser.add_argument(
        ...
        type=str,
        default="3",
        help="Camera number 1-4, or 'all' to store every camera's columns in one dic",
    )
    parser.add_argument(
        "--skip_orbits",
        type=int,
    ...
    parser.add_argument(
        "--no_save", action="store_true", help="Return data without writing pickle"
    )
